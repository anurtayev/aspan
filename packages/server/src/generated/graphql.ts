...
export interface File extends IEntry {
  __typename?: "File";
  id: Scalars["ID"];
  metaData?: Maybe<MetaData>;
  type: "File";
...
export interface Folder extends IEntry {
  __typename?: "Folder";
  id: Scalars["ID"];
  metaData?: Maybe<MetaData>;
  type: "Folder";
...
> = {
  ...
  >;
  attributes?: Resolver<
    Maybe<Array<Array<ResolversTypes["String"]>>>,
    ParentType,
    ContextType
  >;
...
> = {
  addTag?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationAddTagArgs, "id" | "tag">
  >;
  removeTag?: Resolver<
    Maybe<ResolversTypes["MetaData"]>,
    ParentType,
    ContextType,
    RequireFields<MutationRemoveTagArgs, "id" | "tag">
  >;
  addAttribute?: Resolver<
    Maybe<ResolversTypes["MetaData"]>,
    ParentType,
    ContextType,
    RequireFields<MutationAddAttributeArgs, "id" | "attribute">
  >;
  removeAttribute?: Resolver<
    Maybe<ResolversTypes["MetaData"]>,
    ParentType,
    ContextType,
    RequireFields<MutationRemoveAttributeArgs, "id" | "attributeKey">
  >;
};
...
> = {
  getRootFolderEntries?: Resolver<
    Maybe<Array<ResolversTypes["Entry"]>>,
    ParentType,
    ContextType
  >;
  getFolderEntries?: Resolver<
    Maybe<Array<ResolversTypes["Entry"]>>,
    ParentType,
    ContextType,
    RequireFields<QueryGetFolderEntriesArgs, "id">
  >;
};
